...
} sunxi_partition; /* __attribute__ ((packed))sunxi_partition; */
...
} sunxi_mbr_t;/* __attribute__ ((packed)) sunxi_mbr_t; */
...
} dl_one_part_info;/* __attribute__ ((packed)) dl_one_part_info; */
...
} sunxi_download_info; /* __attribute__ ((packed)) sunxi_download_info; */
