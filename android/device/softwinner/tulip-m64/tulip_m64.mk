...
$(call inherit-product, device/softwinner/tulip-m64/configs/go/go_base.mk)
$(call inherit-product, device/softwinner/tulip-common/tulip-common.mk)
$(call inherit-product-if-exists, device/softwinner/tulip-m64/modules/modules.mk)
$(call inherit-product, device/softwinner/tulip-m64/hal.mk)
$(call inherit-product, device/softwinner/common/pad.mk)
$(call inherit-product, build/target/product/go_defaults.mk)

DEVICE_PACKAGE_OVERLAYS := device/softwinner/tulip-m64/overlay \
...
# vndk
PRODUCT_PACKAGES += tulip-m64-vndk
endif
...
PRODUCT_COPY_FILES += \
    device/softwinner/tulip-m64/kernel:kernel \
    device/softwinner/tulip-m64/fstab.sun50iw1p1:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.sun50iw1p1 \
    device/softwinner/tulip-m64/init.device.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.device.rc \
    device/softwinner/tulip-m64/init.recovery.sun50iw1p1.rc:root/init.recovery.sun50iw1p1.rc \
	device/softwinner/tulip-m64/modules/modules/ft5x16_ts.ko:recovery/root/ft5x16_ts.ko \
...
# audio
PRODUCT_COPY_FILES += \
    device/softwinner/tulip-m64/configs/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml
