...
# recovery fs table
TARGET_RECOVERY_FSTAB := device/softwinner/tulip-p3/recovery.fstab

DEVICE_MANIFEST_FILE := device/softwinner/tulip-p3/configs/manifest.xml
DEVICE_MATRIX_FILE := device/softwinner/tulip-p3/configs/compatibility_matrix.xml
...
ifeq ($(BOARD_WIFI_VENDOR), realtek)
    ...
    WIFI_DRIVER_MODULE_NAME     := "8723bs_vq0"
    WIFI_DRIVER_MODULE_PATH     := "/vendor/modules/8723bs-vq0.ko"
