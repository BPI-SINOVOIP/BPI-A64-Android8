...
# recovery fs table
TARGET_RECOVERY_FSTAB := device/softwinner/tulip-p4/recovery.fstab

DEVICE_MANIFEST_FILE := device/softwinner/tulip-p4/configs/manifest.xml
DEVICE_MATRIX_FILE := device/softwinner/tulip-p4/configs/compatibility_matrix.xml
