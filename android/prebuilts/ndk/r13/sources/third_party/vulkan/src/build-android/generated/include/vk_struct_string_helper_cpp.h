...
std::string vk_print_vkallocationcallbacks(const VkAllocationCallbacks* pStruct, const std::string prefix)
{
// CODEGEN : file ../vk_helper.py line #912
    ...
    stringstream ss[6];
// CODEGEN : file ../vk_helper.py line #1069
...
// CODEGEN : file ../vk_helper.py line #1011
    if (pStruct->pNext) {
// CODEGEN : file ../vk_helper.py line #1015
...
// CODEGEN : file ../vk_helper.py line #1092: NB Edit this section to choose hex vs dec output by variable name
...
// CODEGEN : file ../vk_helper.py line #933
// CODEGEN : file ../vk_helper.py line #938
        stp_strs[1] = "";
...
// CODEGEN : file ../vk_helper.py line #986
...
// CODEGEN : file ../vk_helper.py line #1060
    ss[2] << "0x" << (void*)pStruct->pWaitSemaphores;
// CODEGEN : file ../vk_helper.py line #1089: NB: Edit here to choose hex vs dec output by variable name
...
// CODEGEN : file ../vk_helper.py line #912
    ...
    stringstream ss[6];
    string stp_strs[3];
// CODEGEN : file ../vk_helper.py line #1037
...
// CODEGEN : file ../vk_helper.py line #1045
    ss[0].str("");
// CODEGEN : file ../vk_helper.py line #1037
...
// CODEGEN : file ../vk_helper.py line #1057
...
// CODEGEN : file ../vk_helper.py line #912
    ...
    string stp_strs[3];
// CODEGEN : file ../vk_helper.py line #931
// CODEGEN : file ../vk_helper.py line #936
// CODEGEN : file ../vk_helper.py line #938
    stp_strs[0] = "";
    stringstream index_ss;
...
// CODEGEN : file ../vk_helper.py line #1023
...
// CODEGEN : file ../vk_helper.py line #1063
...
// CODEGEN : file ../vk_helper.py line #938
        ...
        if (pStruct->pDynamicStates) {
            for (uint32_t i = 0; i < pStruct->dynamicStateCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file ../vk_helper.py line #973
...
#endif //VK_USE_PLATFORM_XLIB_KHR
// CODEGEN : file ../vk_helper.py line #1121
...
// CODEGEN : file ../vk_helper.py line #1140
...
// CODEGEN : file ../vk_helper.py line #1147
std::string dynamic_display(const void* pStruct, const std::string prefix)
{
    using namespace std;
    ...
    switch (sType)
    {
        ...
        default:
        return string();
// CODEGEN : file ../vk_helper.py line #1173
    }
}