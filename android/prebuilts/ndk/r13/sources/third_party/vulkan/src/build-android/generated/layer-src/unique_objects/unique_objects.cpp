...
// CODEGEN : file ../vk-layer-generate.py line #1371
...
{
// CODEGEN : file ../vk-layer-generate.py line #1501
...
// CODEGEN : file ../vk-layer-generate.py line #1461
...
// CODEGEN : file ../vk-layer-generate.py line #1607
...
// CODEGEN : file ../vk-layer-generate.py line #1607
    ...
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file ../vk-layer-generate.py line #1578
...
// CODEGEN : file ../vk-layer-generate.py line #1595
    lock.lock();
...
// CODEGEN : file ../vk-layer-generate.py line #1607
    ...
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file ../vk-layer-generate.py line #1568
