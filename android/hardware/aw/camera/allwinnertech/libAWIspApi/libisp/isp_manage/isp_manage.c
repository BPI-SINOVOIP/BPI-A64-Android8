...
static void __isp_ctx_cfg_mod(struct isp_lib_context *isp_gen)
{
	...
	*/
	...
	if (param->isp_test_settings.lsc_en == 1) {
        //if (param->isp_tunning_settings.lsc_tbl == 0) {
        //  ISP_WARN("isp_gen->isp_ini_cfg.isp_tunning_settings.lsc_tbl is NULL!\n");
        //} else {
...
HW_S32 __isp_ctx_update_pltm_cfg(struct isp_lib_context *isp_gen)
{
	...
	//pltm table
	clear(isp_gen->pltm_entity_ctx.pltm_param);
	isp_gen->pltm_entity_ctx.pltm_param.u.pltm_tbl = &isp_gen->module_cfg.pltm_cfg.pltm_table[0];
	...
	memcpy(isp_gen->pltm_entity_ctx.pltm_param.u.pltm_ini.pow_tab_base,
		(HW_U8 *)isp_gen->isp_ini_cfg.isp_tunning_settings.isp_pltm_table + 256*sizeof(HW_U16), 256*sizeof(HW_U16));
	memcpy(isp_gen->pltm_entity_ctx.pltm_param.u.pltm_ini.f_tab_base,
		(HW_U8 *)isp_gen->isp_ini_cfg.isp_tunning_settings.isp_pltm_table + 512*sizeof(HW_U16), 256*sizeof(HW_U16));
