...
if (CMAKE_SYSTEM_NAME MATCHES Android)
    ...
    set (HEADERS
        ...
        linux/ml_command_generator.h
	linux/ml_sensor_parsing.h
    )
    set (SOURCES
        ${SOURCES}
        #linux/mlos_linux.c
        ...
        linux/ml_command_generator.c
	linux/ml_sensor_parsing.c
    )
...
elseif (CMAKE_SYSTEM_NAME MATCHES Linux)
    ...
    set (SOURCES
        ${SOURCES}
        #linux/mlos_linux.c
        # HACK, we should find a better solution, perhaps put these in a Linux's libmlplatform
        ${SOLUTION_SOURCE_DIR}/core/driver/linux/userspace/log_linux.c
        ${SOLUTION_SOURCE_DIR}/core/driver/linux/userspace/log_printf_linux.c
    )
