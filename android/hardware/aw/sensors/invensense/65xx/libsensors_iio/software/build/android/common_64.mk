...
#--yd ANDROID_LINK_EXECUTABLE += -Wl,-dynamic-linker,/system/bin/linker
...
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libc/include
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libstdc++/include
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libc/kernel/common
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libc/kernel/arch-arm
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libm/include
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libm/include/arch/arm
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libthread_db/include
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libm/arm
#--yd ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libm
