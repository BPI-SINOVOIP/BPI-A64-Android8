...
BUILD_ANDROID_MARSHMALLOW = $(shell test -d $(ANDROID_ROOT)/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9 && echo 1)

MK_NAME = $(notdir $(CURDIR)/$(firstword $(MAKEFILE_LIST)))
OBJFOLDER = $(CURDIR)/obj

ifeq ($(BUILD_ANDROID_MARSHMALLOW),1)
CROSS ?= $(ANDROID_ROOT)/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-
else
CROSS ?= $(ANDROID_ROOT)/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.8/bin/arm-linux-androideabi-
endif
COMP  ?= $(CROSS)gcc
LINK  ?= $(CROSS)gcc 
...
$(LIBRARY) : $(OBJFOLDER) $(INV_OBJS_DST) $(MK_NAME)
	...
	$(LINK) $(LFLAGS) -o $(OBJFOLDER)/$(LIBRARY) $(INV_OBJS_DST) $(LLINK) $(INV_LIBS) $(LLINK)
