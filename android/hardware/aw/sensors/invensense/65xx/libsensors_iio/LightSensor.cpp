...
int LightSensor::batch(int handle, int flags, int64_t ns, int64_t timeout)
{
	...
	LOGE("aw====LightSensor::batch : handle:%d,ns:%d,class : %s",handle,ns,ligSensorInfo.classPath);
...
int LightSensor::setEnable(int32_t handle, int en)
{
	...
	LOGE("aw====LightSensor::setEnable : handle:%d,en:%d,class  : %s",handle,en,ligSensorInfo.classPath);
