...
static struct sensor_t sSensorList[] =
{
    ...
    {"stk3x1x Ambient Light Sensor", "sensortek",1,
    SENSORS_LIGHT_HANDLE_X,
    SENSOR_TYPE_LIGHT, 4096.0f, 1.0f, 0.09f,10000, 0,0,{ } },
    {"stk3x1x Proximity Sensor", "sensortek",1,
    SENSORS_PROXIMITY_HANDLE_X,
    SENSOR_TYPE_PROXIMITY, 1.0f, 0.1f, 0.873f,20000, 0,0,{ } },
#endif
...
int MPLSensor::setDelay(int32_t handle, int64_t ns)
{
    ...
    LOGE("%s setDelay : %llu ns, (%.2f Hz)", sname.string(), ns, 1000000000.f / ns);
#if 1
...
int MPLSensor::update_delay(void)
{
    ...
    if (mEnabled) {
        ...
        LOGE("HAL:wanted rate for all sensors : "
        ...
        if (LA_ENABLED || GR_ENABLED || RV_ENABLED || O_ENABLED) {
            ...
            */
            ...
            if (A_ENABLED) { /* there is only 1 fifo rate for MPUxxxx */
                LOGE("==== enable : 0x%x\n",mEnabled);
                if ((mEnabled & (1 << Gyro)) && mDelays[Gyro] < mDelays[Accelerometer]) {
                    wanted = mDelays[Gyro];
                } else if ((mEnabled & (1 << RawGyro))  && mDelays[RawGyro]
...
int MPLSensor::populateSensorList(struct sensor_t *list, int len)
{
    ...
    static struct sensor_t sSensorList_gyro =
        ...
        GYRO_MPU6050_RANGE, GYRO_MPU6050_RESOLUTION, GYRO_MPU6050_POWER, GYRO_MPU6050_MINDELAY,0,0, {}};
    ...
    static struct sensor_t sSensorList_accel =
        ...
        ACCEL_MPU6050_RANGE, ACCEL_MPU6050_RESOLUTION, ACCEL_MPU6050_POWER, ACCEL_MPU6050_MINDELAY,0,0, {}};
#ifndef NO_ORI
    static struct sensor_t sSensorList_ori =
        {"MPL Orientation", "Invensense", 1, SENSORS_ORIENTATION_HANDLE, SENSOR_TYPE_ORIENTATION,
        360.0f, .00001, GYRO_MPU6050_POWER+ACCEL_MPU6050_POWER, 5000, 0,0,{}};
#endif
#ifndef NO_RV
    static struct sensor_t sSensorList_rv =
        ...
        1.0f, .00001, GYRO_MPU6050_POWER+ACCEL_MPU6050_POWER, 5000, 0,0,{}};
#endif
#ifndef NO_LA
    static struct sensor_t sSensorList_la =
        ...
        ACCEL_MPU6050_RANGE, ACCEL_MPU6050_RESOLUTION, GYRO_MPU6050_POWER+ACCEL_MPU6050_POWER, 5000, 0,0,{}};
#endif
#ifndef NO_GR
    static struct sensor_t sSensorList_gr =
        {"MPL Gravity", "Invensense", 1, SENSORS_GRAVITY_HANDLE, SENSOR_TYPE_GRAVITY,
        9.81f, .00001, GYRO_MPU6050_POWER+ACCEL_MPU6050_POWER, 5000, 0,0,{}};
#endif
