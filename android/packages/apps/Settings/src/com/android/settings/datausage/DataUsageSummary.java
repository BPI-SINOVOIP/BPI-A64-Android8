...
public class DataUsageSummary extends DataUsageBase implements Indexable, DataUsageEditController {
    ...
    private int storedDataUsageTemplate;
    ...
    private BroadcastReceiver mSimStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyIntents.ACTION_SIM_STATE_CHANGED.equals(action)) {
                boolean mSimReady = SystemProperties.get("gsm.sim.state", "UNKNOWN").equals("READY");
                if (mSimReady) {
                    if (findPreference(KEY_MOBILE_USAGE_TITLE) == null) {
                    ...
                    if (findPreference(KEY_MOBILE_USAGE_TITLE) != null) {
                        mDataUsageTemplate = storedDataUsageTemplate;
                        removePreference(KEY_RESTRICT_BACKGROUND);
                        removePreference(KEY_LIMIT_SUMMARY);
                        removePreference(KEY_MOBILE_USAGE_TITLE);
                        removePreference(KEY_MOBILE_DATA_USAGE_TOGGLE);
                        removePreference(KEY_MOBILE_DATA_USAGE);
                        removePreference(KEY_MOBILE_BILLING_CYCLE);
                    }
                }
                updateState();
            }
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* Not support mobile feature before radio on */
        hasMobileData = false;
        ...
        storedDataUsageTemplate = mDataUsageTemplate;
