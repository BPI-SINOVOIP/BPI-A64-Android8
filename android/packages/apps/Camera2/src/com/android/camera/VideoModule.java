...
public class VideoModule extends CameraModule
    ...
    public void init(CameraActivity activity, boolean isSecureCamera, boolean isCaptureIntent) {
        ...
        int mDisplayRotationNow = mActivity.getOrientationManager().getDisplayRotation().getDegrees();
        mUI.setOrientationIndicator(mDisplayRotationNow, false);
    ...
    private void initializeRecorder() {
        ...
        long maxFileSize = mActivity.getStorageSpaceBytes() - Storage.LOW_STORAGE_THRESHOLD_BYTES + Storage.LOW_STORAGE_ADD_BYTES;
       Log.w(TAG, "zjw,maxFileSize = "+maxFileSize +"mActivity.getStorageSpaceBytes() = "+mActivity.getStorageSpaceBytes());
        ...
        mActivity.updateStorageSpaceAndHint(new CameraActivity.OnStorageUpdateDoneListener() {
            ...
            public void onStorageUpdateDone(long bytes) {
                if (bytes <= Storage.LOW_STORAGE_THRESHOLD_BYTES) {
                    ...
                    mUI.setOrientationIndicator(mActivity.getOrientationManager().getDisplayRotation().getDegrees(), true);
                    setFocusParameters();
    ...
    private void switchCamera() {
        ...
        // From onResume
        mZoomValue = 1.0f;
        mUI.setOrientationIndicator(mActivity.getOrientationManager().getDisplayRotation().getDegrees(), false);
