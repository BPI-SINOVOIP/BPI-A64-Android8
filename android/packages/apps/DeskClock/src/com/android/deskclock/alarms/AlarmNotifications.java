...
import com.android.deskclock.util.NotificationChannelsUtil;
...
final class AlarmNotifications {
    ...
    static synchronized void showLowPriorityNotification(Context context,
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NotificationChannelsUtil.ALARM_CHANNEL)
                .setShowWhen(false)
    ...
    static synchronized void showHighPriorityNotification(Context context,
		...
		NotificationChannelsUtil.createDefaultChannel(context);
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NotificationChannelsUtil.ALARM_CHANNEL)
                .setShowWhen(false)
    ...
    private static void updateUpcomingAlarmGroupNotification(Context context,
        ...
        if (summary == null
            ...
            NotificationChannelsUtil.createDefaultChannel(context);
            summary = new NotificationCompat.Builder(context,NotificationChannelsUtil.ALARM_CHANNEL)
                    .setShowWhen(false)
    ...
    static synchronized void showAlarmNotification(Service service, AlarmInstance instance) {
		...
		NotificationChannelsUtil.createDefaultChannel(service);
        NotificationCompat.Builder notification = new NotificationCompat.Builder(service, NotificationChannelsUtil.ALARM_CHANNEL)
        ...
        PendingIntent snoozePendingIntent = PendingIntent.getForegroundService(service,
        ...
        PendingIntent dismissPendingIntent = PendingIntent.getForegroundService(service,
