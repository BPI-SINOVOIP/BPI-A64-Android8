...
class TimerNotificationBuilder {
    ...
    public Notification build(Context context, NotificationModel nm, List<Timer> unexpired) {
        ...
        final PendingIntent pendingShowApp =
                PendingIntent.getForegroundService(context, REQUEST_CODE_UPCOMING, showApp,
                        PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationChannelsUtil.createDefaultChannel(context);
        final Builder notification = new NotificationCompat.Builder(context,NotificationChannelsUtil.ALARM_CHANNEL)
                .setOngoing(true)
                .setLocalOnly(true)
                .setShowWhen(false)
                .setAutoCancel(false)
        ...
        if (Utils.isNOrLater()) {
            ...
            if (timer.isRunning() && remainingTime > MINUTE_IN_MILLIS) {
                ...
                final PendingIntent pi =
                        PendingIntent.getForegroundService(context, REQUEST_CODE_UPCOMING, updateNotification,
                                PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_UPDATE_CURRENT);
                ...
                final PendingIntent pi = PendingIntent.getForegroundService(context, 0, updateNotification,
    ...
    Notification buildMissed(Context context, NotificationModel nm,
        ...
        final PendingIntent pendingShowApp =
                PendingIntent.getForegroundService(context, REQUEST_CODE_MISSING, showApp,
                        PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_UPDATE_CURRENT);
