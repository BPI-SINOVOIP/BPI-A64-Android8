...
public class FilterShowActivity extends FragmentActivity implements OnItemClickListener,
            ...
            if (filterRepresentation.allowsSingleInstanceOnly()) {
                ...
                if (!representation.equals(filterRepresentation)) {
                    if (representation instanceof FilterRotateRepresentation) {
                        ((FilterRotateRepresentation)representation).set((FilterRotateRepresentation)filterRepresentation);
                    } else if (representation instanceof FilterMirrorRepresentation) {
                        ((FilterMirrorRepresentation)representation).set((FilterMirrorRepresentation)filterRepresentation);
                    } else {
    ...
    public void showRepresentation(FilterRepresentation representation) {
        ...
        FilterRepresentation tmpFR = MasterImage.getImage().getPreset().getRepresentation(representation);
        if (representation instanceof FilterRotateRepresentation) {
            FilterRotateRepresentation r = (FilterRotateRepresentation) representation;
            r.set((FilterRotateRepresentation) tmpFR);
            r.rotateCW();
        }
        if (representation instanceof FilterMirrorRepresentation) {
            ...
            r.set((FilterMirrorRepresentation) tmpFR);
            r.cycle();
        }
