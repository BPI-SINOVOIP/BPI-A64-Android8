        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    e.printStackTrace();
                    TrimVideo.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(TrimVideo.this, TrimVideo.this.getString(R.string.video_trim_err),
                    ...
                    public void run() {
                        ...
                        if (mProgress != null) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                Uri fileUri = FileProvider.getUriForFile(TrimVideo.this, "com.android.gallery3d.fileprovider", mDstFileInfo.mFile);
                                intent.setDataAndType(fileUri, "video/*");
                                intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
                                VideoUtils.grantUriPermission(TrimVideo.this, fileUri, intent);
                            } else {
