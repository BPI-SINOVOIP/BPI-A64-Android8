...
public final class ActiveServices {
    ...
    // We add whitelist for backgroud start of service here.
    // 1. com.google.android.apps.nbu.files:files go
    // files go sometimes got a warning dialog, because a backgroud start of FirebaseInstanceIdService is blocked by system.
    private boolean isServiceWhitelisted(ServiceRecord r){
        return r.packageName.equals("com.google.android.apps.nbu.files") ||
            r.packageName.equals("com.softwinner.fireplayer");
    }
    ...
    ComponentName startServiceLocked(IApplicationThread caller, Intent service, String resolvedType,
        ...
        if (!r.startRequested && !fgRequired) {
            ...
            if ((allowed != ActivityManager.APP_START_MODE_NORMAL) && (!isServiceWhitelisted(r))) {
