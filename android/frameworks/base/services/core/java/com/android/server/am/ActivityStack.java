...
class ActivityStack<T extends StackWindowController> extends ConfigurationContainer
    ...
    private void boost_up_perf(ActivityRecord next) {
        ...
        if (ret > 0 ) {
            ...
            // extreme to normal
            Log.i("ActivityStack", "powerhint:normal");
    ...
    private boolean resumeTopActivityInnerLocked(ActivityRecord prev, ActivityOptions options) {
        ...
        ActivityManagerService.LocalService localService =mService.new LocalService();
        ...
        if (localService.isSystemReady()) {
            Slog.d("ActivityStack","isSystemReady");
            boost_up_perf(next);
        }
