...
#define OMX_VIDEO_DEC_INPUT_BUFFER_SIZE_SECURE (1*1024*1024) // 1MB, (256 kB is not enought)
...
public:
    ...
    OMX_BOOL               bExitRenderThreadFlag;
    ...
    CdcMessageQueue* mqRenderThread;
