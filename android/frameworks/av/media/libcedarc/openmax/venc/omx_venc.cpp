...
OMX_ERRORTYPE omx_venc::component_init(OMX_STRING pName)
{
    ...
    m_sInPortDefType.format.video.nStride            = WIDTH_DEFAULT;
...
#endif
    m_sInPortDefType.nBufferSize = (OMX_U32)(m_sInPortDefType.format.video.nFrameWidth *
                                             m_sInPortDefType.format.video.nFrameHeight * 3 / 2);
    ...
    switch (eParamIndex)
    {
        case OMX_IndexParamPortDefinition:
        {
                ...
                m_sInPortDefType.nPortIndex)
            {
                ...
                m_sInPortDefType.format.video.nStride =
                    ALIGN_16B(m_sInPortDefType.format.video.nStride);
                m_sInPortDefType.nBufferSize =
                    m_sInPortDefType.format.video.nFrameWidth * m_sInPortDefType.format.video.nFrameHeight *3/2;
        ...
        case OMX_IndexConfigVideoBitrate:
        {
            ...
            if (pData->nPortIndex == 1)
            {
                if (m_state == OMX_StateExecuting && m_encoder)
                {
                    ...
                    post_message_to_venc(this, OMX_Venc_Cmd_ChangeBitrate);
                    logv("FUNC:%s, LINE:%d , pData->nEncodeBitrate = %lu",
...
void init_h264_param(omx_venc* pVenc)
{
    ...
    if (pVenc->m_vencH264Param.nMaxKeyInterval <= 0 ||
        pVenc->m_vencH264Param.nMaxKeyInterval >= 500)
    {
    ...
    switch (pVenc->m_sH264Type.eLevel)
    {
        ...
        {
            pVenc->m_vencH264Param.sProfileLevel.nLevel = VENC_H264Level1;
            break;
        }
        ...
        {
            pVenc->m_vencH264Param.sProfileLevel.nLevel = VENC_H264Level11;
            break;
        }
        case OMX_VIDEO_AVCLevel12:
        {
            pVenc->m_vencH264Param.sProfileLevel.nLevel = VENC_H264Level12;
            break;
        }
        case OMX_VIDEO_AVCLevel2:
        {
            pVenc->m_vencH264Param.sProfileLevel.nLevel = VENC_H264Level2;
            break;
        }
        case OMX_VIDEO_AVCLevel21:
        {
            pVenc->m_vencH264Param.sProfileLevel.nLevel = VENC_H264Level21;
            break;
        }
        case OMX_VIDEO_AVCLevel22:
        {
            pVenc->m_vencH264Param.sProfileLevel.nLevel = VENC_H264Level22;
            break;
        }
