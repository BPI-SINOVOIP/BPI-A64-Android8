...
LOCAL_JAVACFLAGS += -g -Xlint -Xlint:-options
-include tools/tradefederation/core/error_prone_rules.mk

LOCAL_MODULE := google-tradefed-contrib
LOCAL_MODULE_TAGS := optional
LOCAL_JAVA_LIBRARIES := tradefed google-tradefed google-tf-prod-tests tf-prod-tests
