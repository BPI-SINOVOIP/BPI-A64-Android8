...
/**
 * A {@link FastbootDeviceFlasher} for flashing Fugu devices
 */
public class FuguDeviceFlasher extends FastbootDeviceFlasher {
    private static final String MIN_BOOTLOADER = "FUGU-01.07";
