...
/**
 * A {@link FastbootDeviceFlasher} for flashing Sprat devices
 */
public class SpratDeviceFlasher extends FastbootDeviceFlasher {
    private static final String MIN_BOOTLOADER = "SPRAT.ND4";
    ...
    protected boolean checkAndFlashBootloader(ITestDevice device, IDeviceBuildInfo deviceBuild)
        ...
        // bootloader smaller than SPRAT.ND4 requires some strange intermediate files.
