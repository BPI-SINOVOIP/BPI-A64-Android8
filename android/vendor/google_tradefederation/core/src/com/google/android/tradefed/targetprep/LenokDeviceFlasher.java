...
/**
 * A {@link FastbootDeviceFlasher} for flashing Lenok devices
 */
public class LenokDeviceFlasher extends FastbootDeviceFlasher {
    private static final String MIN_BOOTLOADER = "LENOKZ09f";
