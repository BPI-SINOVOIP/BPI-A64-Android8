...
/**
 * A {@link FastbootDeviceFlasher} for flashing Bass devices
 */
public class BassDeviceFlasher extends FastbootDeviceFlasher {
    private static final String MIN_BOOTLOADER = "BASSZ09f";
