...
/**
 * A {@link FastbootDeviceFlasher} for flashing Tetra devices
 */
public class TetraDeviceFlasher extends FastbootDeviceFlasher {
    private static final String MIN_BOOTLOADER = "TETRA19";
