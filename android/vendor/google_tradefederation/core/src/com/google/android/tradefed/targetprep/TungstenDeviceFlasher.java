...
/**
 * A {@link FastbootDeviceFlasher} for flashing Tungsten devices
 */
public class TungstenDeviceFlasher extends FastbootDeviceFlasher {
    private static final String MLO_IMAGE_NAME = "MLO";
    private static final String MIN_BOOTLOADER = "steelheadB1003";
