...
/**
 * A {@link FastbootDeviceFlasher} for flashing Volantis
 */

public class VolantisDeviceFlasher extends FastbootDeviceFlasher {

    /** The minimum bootloader version that we support flashing to/from */
    static final String MIN_BOOTLOADER_VERSION = "3.22.0.2100";
    ...
    protected boolean checkAndFlashBootloader(ITestDevice device, IDeviceBuildInfo deviceBuild)
        ...
        // 3.22.0.2100
        // 3.21.0.2100
        if (!newVersion.matches("^\\d{1}\\.\\d{2}\\.\\d{1}\\.\\d{4}$")) {
