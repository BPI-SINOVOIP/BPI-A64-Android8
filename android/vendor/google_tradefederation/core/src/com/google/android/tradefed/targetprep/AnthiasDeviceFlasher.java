...
/**
 * A {@link FastbootDeviceFlasher} for flashing Anthias devices
 */
public class AnthiasDeviceFlasher extends FastbootDeviceFlasher {
    private static final String MIN_BOOTLOADER = "ANTHIAS1518";
    ...
    protected void checkAndFlashBaseband(ITestDevice device, IDeviceBuildInfo deviceBuild) {
        // ignore, Anthias has no baseband
    }
