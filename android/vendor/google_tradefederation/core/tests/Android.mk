...
LOCAL_MODULE := google-tradefed-tests
LOCAL_MODULE_TAGS := optional
LOCAL_STATIC_JAVA_LIBRARIES := easymock google-http-client truth-host-prebuilt
LOCAL_JAVA_LIBRARIES := tradefed google-tradefed loganalysis host-libprotobuf-java-full tradefed-tests
